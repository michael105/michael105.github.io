...
(a nonconformant and nonoptimized recursive seq implementation)
...
#	define VOID { '0', '0', '0', '0', '0', '0', '0', '0', '0', '\n' } 

	char ZERO[] = VOID; // seems ok to assume


	// A philosophical question.
	// it works, therefore it's true.
	char *p = ZERO + sizeof( (char[]) VOID ) - 2 ; 
	...
	for ( ; i<= to; i++ ){
			write(STDOUT_FILENO, p, ZERO + sizeof( (char[]) VOID ) - p );
			p=count(last,p);
	}
